...
const Profile = () => {
  return (  
    <div className=" flex flex-col ">
      ...
      {/* Profile area */}
      <div className=" grid grid-flow-row lg:grid-cols-2 grid-cols-1 mx-auto gap-1  ">
        {/* upper profile */}
        <div className="  grid grid-flow-col  px-5 items-center justify-start   gap-8 lg:gap-16">
          <div className="   relative w-32 lg:w-44 h-full   ">
            <img
          ...
          <div className=" flex flex-col self-start ">
            <div className="flex items-center gap-2 Lg:text-2xl text-xl  justify-start   ">
              <h1 className=" py-3 font-semibold whitespace-nowrap">
                {data.name}
              </h1>
              <MdLightbulbCircle className=" text-blue-700  text-2xl rounded-full  font-semibold" />
              <RiVerifiedBadgeFill className=" text-green-700  text-2xl rounded-full font-semibold " />
            </div>
            <div className="flex gap-2 justify-stretch ">
              <div className=" flex flex-col items-center grow">
                <h1 className=" rounded-lg ring-1 ring-gray-400 text-2xl font-bold text-gray-400 shadow-none px-3 py-1">
                  {data.follower}
                </h1>
                <h1 className=" text-sm text-slate-400  ">Followers</h1>
              </div>
              <div className=" flex flex-col items-center grow">
                <h1 className=" rounded-lg ring-1 ring-slate-400 text-2xl font-bold text-slate-400 shadow-none px-3 py-1">
                  {data.following}
                </h1>
                <h1 className=" text-sm text-slate-400  ">Following</h1>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className=" flex flex-col  items-start px-5 py-3 ">
          <h1 className=" lg:text-2xl  text-slate-500 whitespace-nowrap">
            {data.description}
          </h1>
          <a className=" text-blue-500 text-sm" href={data.id}>
            {data.id}
          </a>
      ...
      <div className=" flex w-full">
        ...
        <button className=" self-start text-2xl font-semibold text-blue-400 bg-white px-3 rounded-md border-solid border-r-2 border-t-2 border-l-2 rounded-br-none whitespace-nowrap py-3   ">
