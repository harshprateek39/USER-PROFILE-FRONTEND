  ...
  return (
    <div className=' flex flex-col '>
             ...
             <FaRegThumbsUp />
                ...
                <h1 className=' text-2xl text-gray-500 lg:px-6 px-2 '>{description}</h1>
 
           <div className=' flex justify-between items-center py-10 lg:px-6 px-2  gap-5' >
            <h1 className=' font-sans font-bold text-gray-500  '><span className=' text-blue-400 font-sans font-bold'>musing</span> by anujgosalia</h1>
            <h1 className=' text-gray-500  '>{date} · {read}· {views} views</h1>
           </div>
